...
@section('content')
    ...
    <div class="p-xl max-w-max-content-width w-full mx-auto space-y-xl">
        ...
        <section class="grid grid-cols-1 lg:grid-cols-3 gap-lg">
            <div
                class="lg:col-span-2 glass-card p-lg rounded-xl flex flex-col justify-center relative overflow-hidden group min-w-0 w-full">
                ...
                <h4 class="font-headline-md text-headline-md text-primary mb-sm relative z-10 w-full">
                    Conselho Paroquial
                </h4>
                <p
                    class="font-body-md text-body-md text-on-surface-variant relative z-10 w-full max-w-none whitespace-normal break-normal leading-relaxed">
