...
<div class="p-xl flex-grow flex flex-col items-center gap-xl overflow-y-auto">
    <div class="w-full max-w-content-width">
        <div class="mb-xl">
            <h3 class="font-headline-md text-headline-md text-primary">Usuários</h3>
        ...
        <form class="grid grid-cols-1 md:grid-cols-12 gap-lg" action="{{ route('users.update', $user->id) }}"
            method="POST">
            @csrf
            @method('PUT')
            <!-- Basic Info Card -->
                ...
                <div class="grid grid-cols-1 gap-lg">
                    <div class="flex flex-col gap-xs">
                        ...
                        <input
                            ...
                            id="nome" name="name" placeholder="Ex: João da Silva" type="text"
                    ...
                    <div class="flex flex-col gap-lg">
                        <div class="flex flex-col gap-xs">
                            ...
                            <select
                                ...
                                <option value="0" @selected(old('access_level', $user->access_level) == 0)>Usuário
                                </option>
                                <option value="1" @selected(old('access_level', $user->access_level) == 1)>Administrador
                                </option>
                            </select>
                        </div>
                    </div>
